...
include("config.php");
	...
	$slika = ($_POST['slika']);
     ...
     $sql = "INSERT INTO nina2_ponuda (Vrsta, Model, Cena, Slika) VALUES ('".$vrsta."', '".$model."', '".$cena."', '".$slika."')";
...
echo "Uspešno ste dodali vašu ponudu!";
} else {
...
<body>
    ...
    <div class="banner">
    <h1 class="kontakt">Dodaj proizvod</h1>
        <div class="topnav" id="myTopnav">
            <a href="../odlogujse/ninnahdesign.php" class="active"><img src="../img/logoo.png" alt="Logo" class="logo"></a>
              <a href="../odlogujse/ninnahdesign.php" class="navbar">Početna</a>
              <a href="../view/ponuda.php" class="navbar">Ponuda</a>
              <a href="../odlogujse/kontakto.php" class="navbar">Kontakt</a>
              <a href="#" class="navbar" onclick="document.getElementById('loginModal').style.display='block'" style="width:auto; ">Upload</a>
  ...
  <div class="kontakt-forma">
      <form id="kontakt-forma" method="post" action="">
        <input type="text"  name="vrsta" class="unos" placeholder="Vrsta" required>
          <br>
          <input type="text"  name="model" class="unos" placeholder="Model" required>
          <br>
          <input type="text"  name="cena" class="unos" placeholder="Cena" required>
          <br>
        <input type="file" name="slika" class="unos">
        <br>
            <input type="submit" class="unos potvrdi" value="Dodaj proizvod">
      </form>
