...
<div class="banner">
    <h1 class="kontakt">Registruj se</h1>
...
<br><br><br><br><br>
  ...
  <div class="kontakt-forma">
      <form id="kontakt-forma" method="post" action="../index.php">
          ...
          <br>
            <input type="password" name="lozinka" class="unos" placeholder="Lozinka" required>
              <br>
              <input type="submit" class="unos potvrdi" value="Registruj se">
      </form>
  </div>
